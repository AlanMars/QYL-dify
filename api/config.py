...
DEFAULTS = {
    ...
    'CNY_POWER_EXCHANGE_RATE': 100,
    'WORKSPACE_PREMIUM_RATE_DEFAULT': 1.0,
    'MODEL_PREMIUM_RATE_OPENAI_GPT_35_TURBO': 1.5,
    'MODEL_PREMIUM_RATE_OPENAI_GPT_35_TURBO_INSTRUCT': 1.5,
    'MODEL_PREMIUM_RATE_OPENAI_GPT_35_TURBO_16K': 1.5,
    'MODEL_PREMIUM_RATE_OPENAI_GPT_40_TURBO': 1.25,
    'MODEL_PREMIUM_RATE_OPENAI_GPT_40_TURBO_32K': 1.25,
    'MODEL_PREMIUM_RATE_OPENAI_TEXT_DAVINCI_003': 1.25,
    'MODEL_PREMIUM_RATE_OPENAI_TEXT_EMBEDDING_ADA_002': 1.25,
    'MODEL_PREMIUM_RATE_OPENAI_WHISPER_1': 1.5,
    'MODEL_PREMIUM_RATE_AZURE_OPENAI_GPT_35_TURBO': 1.5,
    'MODEL_PREMIUM_RATE_AZURE_OPENAI_GPT_35_TURBO_16K': 1.5,
    'MODEL_PREMIUM_RATE_AZURE_OPENAI_GPT_40_TURBO': 1.25,
    'MODEL_PREMIUM_RATE_AZURE_OPENAI_TEXT_EMBEDDING_ADA_002': 1.25,
    'MODEL_PREMIUM_RATE_ANTHROPIC_CLAUDE': 1.25,
    'MODEL_PREMIUM_RATE_ANTHROPIC_CLAUDE_2': 1.25,
    'MODEL_PREMIUM_RATE_ANTHROPIC_CLAUDE_INSTANT': 1.5
}
...
# RACIO
class CloudEditionPremiumConfig(CloudEditionConfig):

    def __init__(self):
        super().__init__()

        # USD/CNY Exchange Rate ($1.00 = ￥7.30)
        self.USD_CNY_EXCHANGE_RATE = get_env('USD_CNY_EXCHANGE_RATE')

        # RMB/Power Exchange Rate (￥1.00 = ⚡️100)
        self.CNY_POWER_EXCHANGE_RATE = get_env('CNY_POWER_EXCHANGE_RATE')

        # Workspace Premium Rate
        self.WORKSPACE_PREMIUM_RATE_DEFAULT = get_env('WORKSPACE_PREMIUM_RATE_DEFAULT')

        # Model Premium Rate
        self.MODEL_PREMIUM_RATE_OPENAI_GPT_35_TURBO = get_env('MODEL_PREMIUM_RATE_OPENAI_GPT_35_TURBO')
        self.MODEL_PREMIUM_RATE_OPENAI_GPT_35_TURBO_INSTRUCT = get_env('MODEL_PREMIUM_RATE_OPENAI_GPT_35_TURBO_INSTRUCT')
        self.MODEL_PREMIUM_RATE_OPENAI_GPT_35_TURBO_16K = get_env('MODEL_PREMIUM_RATE_OPENAI_GPT_35_TURBO_16K')
        self.MODEL_PREMIUM_RATE_OPENAI_GPT_40_TURBO = get_env('MODEL_PREMIUM_RATE_OPENAI_GPT_40_TURBO')
        self.MODEL_PREMIUM_RATE_OPENAI_GPT_40_TURBO_32K = get_env('MODEL_PREMIUM_RATE_OPENAI_GPT_40_TURBO_32K')
        self.MODEL_PREMIUM_RATE_OPENAI_TEXT_DAVINCI_003 = get_env('MODEL_PREMIUM_RATE_OPENAI_TEXT_DAVINCI_003')
        self.MODEL_PREMIUM_RATE_OPENAI_TEXT_EMBEDDING_ADA_002 = get_env('MODEL_PREMIUM_RATE_OPENAI_TEXT_EMBEDDING_ADA_002')
        self.MODEL_PREMIUM_RATE_OPENAI_WHISPER_1 = get_env('MODEL_PREMIUM_RATE_OPENAI_WHISPER_1')

        self.MODEL_PREMIUM_RATE_AZURE_OPENAI_GPT_35_TURBO = get_env('MODEL_PREMIUM_RATE_AZURE_OPENAI_GPT_35_TURBO')
        self.MODEL_PREMIUM_RATE_AZURE_OPENAI_GPT_35_TURBO_16K = get_env('MODEL_PREMIUM_RATE_AZURE_OPENAI_GPT_35_TURBO_16K')
        self.MODEL_PREMIUM_RATE_AZURE_OPENAI_GPT_40_TURBO = get_env('MODEL_PREMIUM_RATE_AZURE_OPENAI_GPT_40_TURBO')
        self.MODEL_PREMIUM_RATE_AZURE_OPENAI_TEXT_EMBEDDING_ADA_002 = get_env('MODEL_PREMIUM_RATE_AZURE_OPENAI_TEXT_EMBEDDING_ADA_002')

        self.MODEL_PREMIUM_RATE_ANTHROPIC_CLAUDE = get_env('MODEL_PREMIUM_RATE_ANTHROPIC_CLAUDE')    
        self.MODEL_PREMIUM_RATE_ANTHROPIC_CLAUDE_2 = get_env('MODEL_PREMIUM_RATE_ANTHROPIC_CLAUDE_2')
        self.MODEL_PREMIUM_RATE_ANTHROPIC_CLAUDE_INSTANT = get_env('MODEL_PREMIUM_RATE_ANTHROPIC_CLAUDE_INSTANT')
