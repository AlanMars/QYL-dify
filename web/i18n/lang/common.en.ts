const translation = {
  ...
  account: {
    ...
    langGeniusAccount: 'RACIO account',
    langGeniusAccountTip: 'Your RACIO account and associated user data.',
    editName: 'Edit Name',
  ...
  members: {
    ...
    invitationSentTip: 'Invitation sent, and they can sign in to RACIO to access your team data.',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      desc: 'The OpenAI hosting service provided by RACIO allows you to use models such as GPT-3.5. Before your trial quota is used up, you need to set up other model providers.',
  ...
  apiBasedExtension: {
    title: 'API-based extensions provide centralized API management, simplifying configuration for easy use across RACIO\'s applications.',
    link: 'Learn how to develop your own API Extension.',
    linkUrl: 'https://docs.racio.ai/advanced/api_based_extension',
  ...
  about: {
    ...
    nowAvailable: 'RACIO {{version}} is now available.',
    latestAvailable: 'RACIO {{version}} is the latest version available.',
  },
  appMenus: {
    overview: 'Overview',
