const translation = {
  ...
  welcome: 'Welcome to RACIO, please log in to continue.',
  email: 'Email address',
  ...
  license: {
    tip: 'Before starting RACIO Community Edition, read the GitHub',
    link: 'Open-source License',
  },
  join: 'Join',
  joinTipStart: 'Invite you join',
  joinTipEnd: 'team on RACIO',
  invalid: 'The link has expired',
  explore: 'Explore RACIO',
